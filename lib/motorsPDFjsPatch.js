(async function (){
    await (async function() {
        ...
        for (const sheet of styleSheets) {
            ...
            sheet.innerHTML = sheet.innerHTML.replace(/x-small/ig, '0.8em');
            sheet.innerHTML = sheet.innerHTML.replace(/font-family: "Arial";/ig, 'font-family: "ArialIgnore";');
            sheet.innerHTML = sheet.innerHTML.replace(/font-family:Arial;/ig, 'font-family: "ArialIgnore";');
            sheet.innerHTML = sheet.innerHTML.replace(/font-family: "arialb", sans-serif;/ig, 'font-family: "Arial", sans-serif;font-weight: bold;');
